...
- [[4.Abstraction]] — Interfaces and abstract classes define the types that polymorphism operates on
- [[2.Inheritance]] — Runtime polymorphism is enabled through method overriding
