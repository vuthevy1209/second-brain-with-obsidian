...
- [[1.Class-And-Object]] — `this` always refers to the current object
- [[3.Constructor, Destructor]] — `this()` for constructor chaining, `super()` for parent constructor
- [[4.Static-vs-Instance]] — `this` is only available in instance context
