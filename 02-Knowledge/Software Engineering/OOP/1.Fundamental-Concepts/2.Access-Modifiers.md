...
- [[1.Encapsulation]] — Access modifiers are the tools that enable encapsulation
- [[2.Inheritance]] — How `protected` is used across class hierarchies
- [[1.Class-And-Object]] — Access modifiers are declared at the class level
