...
- [[1.Class-And-Object]] — Objects are the context in which instance members live
- [[5.This-Keyword]] — `this` is only available in instance context
- [[1.Encapsulation]] — Instance fields should always be private
