...
- **Skills are folders of instructions** that Claude Code can discover and use to handle tasks more accurately. <font color="#8064a2"><mark style="background:#d3f8b6">Each skill lives in a `SKILL.md` file with a name and description in its fronmatter</mark></font>
